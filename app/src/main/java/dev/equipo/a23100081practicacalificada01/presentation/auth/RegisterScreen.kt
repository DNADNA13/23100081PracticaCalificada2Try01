package dev.equipo.a23100081practicacalificada01.presentation.auth
...
import dev.equipo.a23100081practicacalificada01.data.remote.firebase.FirebaseAuthManager
...
fun RegisterScreen (navController: NavController){
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            label = {Text("Confirmar ontraseña")},
            modifier = Modifier.padding(vertical = 8.dp).fillMaxWidth(),
            visualTransformation = PasswordVisualTransformation()
        )
        //Button for register
